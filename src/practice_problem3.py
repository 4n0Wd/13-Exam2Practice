...
def is_prime(n):
    ...
    # ------------------------------------------------------------------
    # Students:
    #   Do NOT touch the above  is_prime  function - it has no TO_DO.
...
def practice_problem3b(sequence):
    ...
    """
    sample = sequence[len(sequence)-1]
    for k in range(len(sequence) - 1):
        if sample == sequence[k]:
            return True
    return False
