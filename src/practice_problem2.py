...
def run_test_practice_problem2a():
    ...
    # Test 1:
    expected = [1, 2]
    actual = practice_problem2a([0, 1], 1)
    print('\nExpected: ', expected)
    print('Actual:   ', actual)

    # Test 2:
    expected = [3, 2]
    actual = practice_problem2a([0, -1], 3)
    print('\nExpected: ', expected)
    print('Actual:   ', actual)

    # Test 3:
    expected = [5]
    actual = practice_problem2a([0], 5)
    print('\nExpected: ', expected)
    print('Actual:   ', actual)

    # Test 4:
    expected = [55555, 99999]
    actual = practice_problem2a([44444, 88888], 11111)
    print('\nExpected: ', expected)
    print('Actual:   ', actual)
